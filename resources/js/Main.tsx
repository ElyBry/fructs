    ...
    return (
        <>
            ...
            <div className={"parallax"} id={"target"}>
                ...
                <div className={"parallaxLayer parallaxImage parallaxLayer-fore"} id={"bgTargetS"}>
                </div>
                <div className={"parallaxLayer content parallaxLayer-base"}>
                    <Header/>
                        ...
                        <div className={"guarantees"}>
                            <div className={"sliderLayout"}>
                                ...
                                <div className={"arrows"}>
                                    <button className={"icons"} id={"leftArrow"}
                                            onClick={(e) => arrowAction("left")}><span
